...
namespace PointCloud.Numerics
{
    ...
    public partial struct Vector2 : IEquatable<Vector2>, IFormattable
    {
        ...
        public Vector2(ReadOnlySpan<double> values)
        {
            this = Create(values);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 operator /(Vector2 value1, double value2) => (value1.AsVector128Unsafe() / value2).AsVector2();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 operator *(Vector2 left, double right) => (left.AsVector128Unsafe() * right).AsVector2();
        ...
        public static Vector2 Create(double value) => Vector128.Create(value).AsVector2();
        ...
        public static Vector2 Create(double x, double y) => Vector128.Create(x, y).AsVector2();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Create(ReadOnlySpan<double> values)
        {
            ...
            return Unsafe.ReadUnaligned<Vector2>(ref Unsafe.As<double, byte>(ref MemoryMarshal.GetReference(values)));
        }
        ...
        internal static Vector2 CreateScalar(double x) => Vector128.CreateScalar(x).AsVector2();
        ...
        internal static Vector2 CreateScalarUnsafe(double x) => Vector128.CreateScalarUnsafe(x).AsVector2();
        ...
        public static double Distance(Vector2 value1, Vector2 value2) => double.Sqrt(DistanceSquared(value1, value2));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double Dot(Vector2 value1, Vector2 value2) => Vector128.Dot(value1.AsVector128(), value2.AsVector128());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Lerp(Vector2 value1, Vector2 value2, double amount) => Lerp(value1, value2, Create(amount));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Log(Vector2 vector) => Vector128.Log(vector.AsVector128()).AsVector2();

        /// <inheritdoc cref="Vector4.Log(Vector4)" />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Log2(Vector2 vector) => Vector128.Log2(vector.AsVector128()).AsVector2();
        ...
        public static Vector2 Transform(Vector2 position, Matrix3x3 matrix) => Transform(position, in matrix.AsImpl());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Vector2 Transform(Vector2 position, in Matrix3x3.Impl matrix)
        {
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Transform(Vector2 position, Matrix4x4 matrix) => Vector4.Transform(position, in matrix.AsImpl()).AsVector256().AsVector2();
        ...
        /// <returns>The transformed vector.</returns>
        public static Vector2 TransformNormal(Vector2 normal, Matrix3x3 matrix) => TransformNormal(normal, in matrix.AsImpl());

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Vector2 TransformNormal(Vector2 normal, in Matrix3x3.Impl matrix)
        {
        ...
        public readonly void CopyTo(double[] array)
        {
            ...
            {
                throw new ArgumentException("DestinationTooShort");
        ...
        public readonly void CopyTo(double[] array, int index)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("index", "StartIndex must be less than"+ (uint)array.Length);
                //ThrowHelper.ThrowStartIndexArgumentOutOfRange_ArgumentOutOfRange_IndexMustBeLess();
            }

            if ((array.Length - index) < Count)
            {
                throw new ArgumentOutOfRangeException("index", "Destination is too short");
                //ThrowHelper.ThrowArgumentException_DestinationTooShort();
            }
