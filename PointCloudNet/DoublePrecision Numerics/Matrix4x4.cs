...
namespace PointCloud.Numerics
{
    ...
    public partial struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        /// <summary>Creates a <see cref="Matrix4x4" /> object from a specified <see cref="Matrix3x3" /> object.</summary>
        ...
        public Matrix4x4(Matrix3x3 value)
        {
            Unsafe.SkipInit(out this);
        ...
        */
        ...
        /// | x + width / 2 | y + height / 2 |       minDepth      | 1 |
        /// </remarks>
        public static Matrix4x4 CreateViewportLeftHanded(double x, double y, double width, double height, double minDepth, double maxDepth)
