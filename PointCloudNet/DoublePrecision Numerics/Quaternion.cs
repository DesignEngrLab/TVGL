...
namespace PointCloud.Numerics
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public double this[int index]
        {
            ...
            set
            {
                this = this.AsVector256().WithElement(index, value).AsQuaternion();
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion operator +(Quaternion value1, Quaternion value2) => (value1.AsVector256() + value2.AsVector256()).AsQuaternion();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Quaternion value1, Quaternion value2) => value1.AsVector256() == value2.AsVector256();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion operator *(Quaternion value1, double value2) => (value1.AsVector256() * value2).AsQuaternion();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion operator -(Quaternion value) => (-value.AsVector256()).AsQuaternion();
        ...
        public static Quaternion Conjugate(Quaternion value)
        {
            ...
            return (value.AsVector256() * Vector256.Create(-1.0f, -1.0f, -1.0f, 1.0f)).AsQuaternion();
        }
        ...
        internal static Quaternion Create(double x, double y, double z, double w) => Vector256.Create(x, y, z, w).AsQuaternion();
        ...
        internal static Quaternion Create(Vector3 vectorPart, double scalarPart) => Vector4.Create(vectorPart, scalarPart).AsQuaternion();
        ...
        public static Quaternion CreateFromAxisAngle(Vector3 axis, double angle)
        {
            ...
            (double s, double c) = double.SinCos(angle * 0.5f);
        ...
        public static Quaternion CreateFromRotationMatrix(Matrix4x4 matrix)
        {
            ...
            if (trace > 0.0f)
            {
                double s = double.Sqrt(trace + 1.0f);
                q.W = s * 0.5f;
                s = 0.5f / s;
            ...
            else
            {
                ...
                {
                    double s = double.Sqrt(1.0f + matrix.M11 - matrix.M22 - matrix.M33);
                    double invS = 0.5f / s;
                    q.X = 0.5f * s;
                ...
                {
                    double s = double.Sqrt(1.0f + matrix.M22 - matrix.M11 - matrix.M33);
                    double invS = 0.5f / s;
                ...
                {
                    double s = double.Sqrt(1.0f + matrix.M33 - matrix.M11 - matrix.M22);
                    double invS = 0.5f / s;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double Dot(Quaternion quaternion1, Quaternion quaternion2) => Vector256.Dot(quaternion1.AsVector256(), quaternion2.AsVector256());
        ...
        public static Quaternion Lerp(Quaternion quaternion1, Quaternion quaternion2, double amount)
        {
            ...
            Vector256<double> result = Vector256.MultiplyAddEstimate(quaternion1.AsVector256(), Vector256.Create(1.0f - amount), q2 * amount);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Quaternion Normalize(Quaternion value) => (value.AsVector256() / value.Length()).AsQuaternion();
        ...
        public static Quaternion Slerp(Quaternion quaternion1, Quaternion quaternion2, double amount)
        {
            ...
            else
            {
                ...
                s1 = double.Sin((1.0f - amount) * omega) * invSinOmega;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Quaternion other) => this.AsVector256().Equals(other.AsVector256());
