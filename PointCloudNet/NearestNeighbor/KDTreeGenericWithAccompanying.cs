...
public class KDTree<TPoint, TAccObject> : KDTree<TPoint>
{
    ...
    internal KDTree(int dimensions, IEnumerable<TPoint> points, IList<TAccObject> accompanyingObjects, DistanceMetric distanceMetric = DistanceMetric.StraightLine)
        : base(points, distanceMetric,dimensions)
    {
