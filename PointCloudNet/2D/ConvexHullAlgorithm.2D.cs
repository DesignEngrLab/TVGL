        ...
        for (int i = convexHull.Count - 1; i >= 0; i++)
        {
            ...
            var midPoint = new T
            {
                Coordinates = new Vector2(
                 0.5f * (nextEndPoint.Coordinates.X + currentEndPoint.Coordinates.X),
                0.5f * (nextEndPoint.Coordinates.Y + currentEndPoint.Coordinates.Y))
            };
            ...
            foreach (var pointData in kdTree.FindNearest(midPoint, radius, -1))
            {
