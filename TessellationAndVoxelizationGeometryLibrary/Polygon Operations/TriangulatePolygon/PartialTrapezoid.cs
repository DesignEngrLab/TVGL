...
#region Trapezoid Class
    ...
    internal class PartialTrapezoid
    {
        ...
        internal PartialTrapezoid(Vertex2D topNode, PolygonEdge leftLine, PolygonEdge rightLine)
        {
            TopNode = topNode;
            LeftLine = leftLine;
            RightLine = rightLine;
        ...
        internal bool Contains(PolygonEdge line1, PolygonEdge line2)
        {
