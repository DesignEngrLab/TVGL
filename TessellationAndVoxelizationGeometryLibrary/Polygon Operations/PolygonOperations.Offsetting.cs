...
namespace TVGL.TwoDimensional
{
    ...
    public static partial class PolygonOperations
    {
            ...
            double tolerance, double deltaAngle = double.NaN)
        {
            ...
            //Compare(allPolygons, pClipper, "Offset", clipTime, tvglTime);
            return pClipper;
        }
            ...
            double tolerance, double deltaAngle = double.NaN)
        {
            ...
            //var pTVGL= outers.IntersectPolygons(inners, tolerance: tolerance).Where(p => p.IsPositive).ToList();

            //sw.Stop();
            //var tvglTime = sw.Elapsed;
            //Compare(pTVGL, pClipper, "OffsetLists", clipTime, tvglTime);
            return pClipper;
        }
