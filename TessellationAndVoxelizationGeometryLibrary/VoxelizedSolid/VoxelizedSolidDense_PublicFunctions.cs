...
namespace TVGL.Voxelization
{
    ...
    /// </summary>
    public partial class VoxelizedSolidByte : IEnumerable<int[]>
    {
        ...
        public override Solid TransformToNewSolid(double[,] transformationMatrix)
        {
            ...
            return new VoxelizedSolidByte(ts, Discretization);
        ...
        {
            return new VoxelizedSolidByte(this);
        }

        public static VoxelizedSolidByte Copy(VoxelizedSolidByte vs)
        {
            return new VoxelizedSolidByte(vs);
        }
        #endregion
        ...
        // i.e. cutBefore = 8, would yield one solid with voxels 0 to 7, and one with 8 to end
        // 0 < cutBefore < VoxelsPerSide[cut direction]
        public (VoxelizedSolidByte, VoxelizedSolidByte) SliceOnFlat(CartesianDirections vd, int cutBefore)
        {
            var cutDir = Math.Abs((int)vd) - 1;
            if (cutBefore >= VoxelsPerSide[cutDir] || cutBefore < 1)
                throw new ArgumentOutOfRangeException();
            ...
            var cutSign = Math.Sign((int)vd);
            var vs1 = (VoxelizedSolidByte)Copy();
            var vs2 = (VoxelizedSolidByte)Copy();
        ...
        public (VoxelizedSolidByte, VoxelizedSolidByte) SliceOnFlat(Flat plane)
        {
            var vs1 = (VoxelizedSolidByte)Copy();
            var vs2 = (VoxelizedSolidByte)Copy();
        ...
        public VoxelizedSolidByte[] VoxelizeSlicedSolid(TessellatedSolid[] solids)
        {
            var output = new List<VoxelizedSolidByte>();
            foreach (var solid in solids)
            {
                var vs = new VoxelizedSolidByte(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
        ...
        public VoxelizedSolidByte CreateBoundingSolid(bool useVoxelBounds = false)
        {
            if (!useVoxelBounds)
                return new VoxelizedSolidByte(VoxelsPerSide, Discretization, VoxelSideLength, Bounds, 1);
        ...
        // NOT A
        public VoxelizedSolidByte InvertToNewSolid()
        {
            var vs = new VoxelizedSolidByte(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
            Parallel.For(0, VoxelsPerSide[0], i =>
            {
        ...
        // A OR B
        public VoxelizedSolidByte UnionToNewSolid(params VoxelizedSolidByte[] solids)
        {
            var vs = (VoxelizedSolidByte)Copy();
            var xLim = VoxelsPerSide[0];
            var yLim = VoxelsPerSide[1];
            var zLim = VoxelsPerSide[2];
            Parallel.For(0, xLim, i =>
        ...
        // A AND B
        public VoxelizedSolidByte IntersectToNewSolid(params VoxelizedSolidByte[] solids)
        {
            var vs = new VoxelizedSolidByte(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
        ...
        // A AND (NOT B)
        public VoxelizedSolidByte SubtractToNewSolid(params VoxelizedSolidByte[] subtrahends)
        {
            var vs = (VoxelizedSolidByte)Copy();
        ...
        public VoxelizedSolidByte DraftToNewSolid(CartesianDirections vd)
        {
            var vs = (VoxelizedSolidByte)Copy();
        ...
        public VoxelizedSolidByte ErodeToNewSolid(VoxelizedSolidByte designedSolid, double[] dir,
            double tLimit = 0, double toolDia = 0, params string[] toolOptions)
        {
            var copy = (VoxelizedSolidByte)Copy();
            copy.ErodeVoxelSolid(designedSolid, dir.normalize(3), tLimit, toolDia, toolOptions);
            copy.UpdateProperties();
            return copy;
        }

        public VoxelizedSolidByte ErodeToNewSolid(VoxelizedSolidByte designedSolid, CartesianDirections dir,
            double tLimit = 0, double toolDia = 0, params string[] toolOptions)
        {
            var copy = (VoxelizedSolidByte)Copy();
        ...
        private void ErodeVoxelSolid(VoxelizedSolidByte designedSolid, double[] dir,
        ...
        private void ErodeMask(VoxelizedSolidByte designedSolid, int[][] mask, byte signX, byte signY,
    ...
    public class VoxelEnumerator : IEnumerator<int[]>
    {
        ...
        int yLim;
        int zLim;
        public VoxelEnumerator(VoxelizedSolidByte vs)
        {
            this.vs = vs;
