...
namespace TVGL.Voxelization
{
    ...
    /// </summary>
    public partial class VoxelizedSolidByte : Solid
    {
        #region Properties
        ...
        public VoxelizedSolidByte(int[] voxelsPerSide, int discretization, double voxelSideLength,
        ...
        public VoxelizedSolidByte(byte[,,] voxels, int discretization, int[] voxelsPerSide, double voxelSideLength,
        ...
        public VoxelizedSolidByte(VoxelizedSolidByte vs)
        {
        ...
        public VoxelizedSolidByte(TessellatedSolid ts, int discretization, IReadOnlyList<double[]> bounds = null)
        {
            TS = ts;
            Discretization = discretization;
            SolidColor = new Color(Constants.DefaultColor);
            var voxelsOnLongSide = Discretization;
