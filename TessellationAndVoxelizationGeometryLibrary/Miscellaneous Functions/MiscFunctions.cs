...
namespace TVGL
{
    ...
    public static class MiscFunctions
    {
        ...
        /// <summary>
        /// Find the volume of a tesselated solid from a plane to some distance along that plane's normal.
        /// If no plane is defined, the entire solid volume will be returned.
        /// </summary>
        /// <param name="ts"></param>
        /// <param name="plane"></param>
        /// <param name="distanceFromPlane"></param>
        /// <returns></returns>
        public static double PartialVolume(TessellatedSolid ts, Flat plane = null, double distanceFromPlane = double.PositiveInfinity)
        {
