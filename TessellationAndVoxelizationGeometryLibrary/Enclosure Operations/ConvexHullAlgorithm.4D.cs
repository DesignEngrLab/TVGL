...
// ***********************************************************************
// <copyright file="ConvexHull4D.cs" company="Design Engineering Lab">
//     2014
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace TVGL
{
    public partial class ConvexHull4D
    {
            ...
            bool connectVerticesToCvxHullFaces, double tolerance = double.NaN)
        {
            ...
            var faceQueue = new UpdatablePriorityQueue<ConvexHullFace4D, double>(simplexFaces.Select(f => (f, f.peakDistance)), new NoEqualSort(false));
