...
namespace TVGL
{
    ...
    {
        #region Constructors
        // These four constructor are presented in order. the first calls the second, the second calls the
        // third, and the third calls the fourth.  
        /// <summary>
