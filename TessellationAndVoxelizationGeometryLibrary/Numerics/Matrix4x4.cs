...
namespace TVGL.Numerics  // COMMENTEDCHANGE namespace System.Numerics
{
    ...
    public readonly struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        public static bool Decompose(Matrix4x4 matrix, out Vector3 scale, out Quaternion rotation, out Vector3 translation)
        {
            ...
            scale = new Vector3(pVectorBasis[0].Length(), pVectorBasis[1].Length(), pVectorBasis[2].Length());
            ...
            if (scale[a] < DecomposeEpsilon)
                pVectorBasis[a] = canonicalBasis[a];
            ...
            if (scale[b] < DecomposeEpsilon)
            {
                ...
                #endregion
                pVectorBasis[b] = Vector3.Cross(pVectorBasis[a], canonicalBasis[cc]);
            }
            ...
            var matTemp = new Matrix4x4(pVectorBasis[0].X, pVectorBasis[0].Y, pVectorBasis[0].Z, pVectorBasis[1].X,
                pVectorBasis[1].Y, pVectorBasis[1].Z, pVectorBasis[2].X, pVectorBasis[2].Y, pVectorBasis[2].Z, 0, 0, 0);
            ...
            if (det < 0.0)
            {
                ...
                switch (a)
                {
                    case 0: scale = new Vector3(-scale.X, scale.Y, scale.Z); break;
                    case 1: scale = new Vector3(-scale.X, -scale.Y, scale.Z); break;
                    default: scale = new Vector3(scale.X, scale.Y, -scale.Z); break;
                }
