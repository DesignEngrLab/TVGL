...
namespace TVGL
{
    ...
    public class Loop : List<ContactElement>
    {
        ...
        /// </summary>
        public readonly bool EnclosesInPlaneFace;
        ...
        /// </summary>
        public readonly bool OnNegativeSolids;

        /// <summary>
        ///     Does the loop belong to the positive solids?
        /// </summary>
        public readonly bool OnPositiveSolids;
        ...
        internal Loop(ICollection<ContactElement> contactElements, IList<double> normal, bool isClosed,
            bool artificiallyClosed,
