...
namespace TVGL.Boolean_Operations.PolygonOperations
{
    #if use_int32
      using cInt = Int32;
    #else
    ...
    public class ClipperInterface
    {
        ...
        /// <returns></returns>
        internal List<List<Point>> OffsetRound(List<List<Point>> loops, double offset, double scale = 100000)
        {
