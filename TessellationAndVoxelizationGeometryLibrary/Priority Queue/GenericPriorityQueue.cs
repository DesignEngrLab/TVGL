...
namespace Priority_Queue
{
    ...
    internal sealed class GenericPriorityQueue<TItem, TPriority> : IFixedSizePriorityQueue<TItem, TPriority>
        where TItem : GenericPriorityQueueNode<TPriority>
       // where TPriority : IComparable<TPriority>  ***This is a commented in our local version of BlueRaja's priority queue
    {
