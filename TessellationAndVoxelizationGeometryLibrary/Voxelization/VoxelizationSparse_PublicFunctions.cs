...
namespace TVGL.Voxelization
{
    ...
    /// </summary>
    public partial class VoxelizedSparse : IEnumerable<int[]>
    {
        ...
        public void UpdateBoundingProperties()
        {
            ...
            {
                NumVoxels = VoxelsPerSide[0] * VoxelsPerSide[1] * VoxelsPerSide[2];
                SurfaceArea =
        ...
        public void UpdateProperties()
        {
            ...
            Volume = NumVoxels * Math.Pow(VoxelSideLength, 3);
            var zMin = 0;
            ...
            SurfaceArea = (6 * NumVoxels - numNeighbors) * Math.Pow(VoxelSideLength, 2);
        }
        #endregion
        ...
        public override Solid TransformToNewSolid(double[,] transformationMatrix)
        {
            ...
            return new VoxelizedSparse(ts, Discretization);
            ...
            //var vs = new VoxelizedSparseDense(newVoxPerSide, Discretization, VoxelSideLength, newBound);
        ...
        //public (VoxelizedSparseDense, VoxelizedSparseDense) SliceOnFlatAndResizeVoxelArrays(VoxelDirections vd, int cutBefore)
        //{
        ...
        //    var vs1 = new VoxelizedSparseDense(voxels1, Discretization, voxelsPerSide1, VoxelSideLength, bounds1);
        ...
        //    var vs2 = new VoxelizedSparseDense(voxels2, Discretization, voxelsPerSide2, VoxelSideLength, bounds2);
        ...
        // i.e. cutBefore = 8, would yield one solid with voxels 0 to 7, and one with 8 to end
        // 0 < cutBefore < VoxelsPerSide[cut direction]
        public (VoxelizedSparse, VoxelizedSparse) SliceOnFlat(CartesianDirections vd, int cutBefore)
        {
            var cutDir = Math.Abs((int)vd) - 1;
            if (cutBefore >= VoxelsPerSide[cutDir] || cutBefore < 1)
                throw new ArgumentOutOfRangeException();
            ...
            var cutSign = Math.Sign((int)vd);
            var vs1 = (VoxelizedSparse)Copy();
            var vs2 = (VoxelizedSparse)Copy();
        ...
        public (VoxelizedSparse, VoxelizedSparse) SliceOnFlat(Flat plane)
        {
            var vs1 = (VoxelizedSparse)Copy();
            var vs2 = (VoxelizedSparse)Copy();
        ...
        //// Solid on positive side of flat is in position one of return tuple
        //// Voxels exactly on the plane are assigned to the positive side
        //public (VoxelizedSparseDense, VoxelizedSparseDense) SliceOnFlatAndResizeVoxelArrays(Flat plane)
        //{
        ...
        public VoxelizedSparse[] VoxelizeSlicedSolid(TessellatedSolid[] solids)
        {
            var output = new List<VoxelizedSparse>();
            foreach (var solid in solids)
            {
                var vs = new VoxelizedSparse(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
                vs.FillInFromTessellation(solid, true);
                vs.UpdateProperties();
                output.Add(vs);
            }
        ...
        public VoxelizedSparse CreateBoundingSolid(bool useVoxelBounds = false)
        {
            if (!useVoxelBounds)
                return new VoxelizedSparse(VoxelsPerSide, Discretization, VoxelSideLength, Bounds, 1);
        ...
        // NOT A
        public VoxelizedSparse InvertToNewSolid()
        {
            var vs = new VoxelizedSparse(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
            Parallel.For(0, VoxelsPerSide[0], i =>
            {
        ...
        // A OR B
        public VoxelizedSparse UnionToNewSolid(params VoxelizedSparse[] solids)
        {
            var vs = (VoxelizedSparse)Copy();
        ...
        // A AND B
        public VoxelizedSparse IntersectToNewSolid(params VoxelizedSparse[] solids)
        {
            var vs = new VoxelizedSparse(VoxelsPerSide, Discretization, VoxelSideLength, Bounds);
        ...
        // A AND (NOT B)
        public VoxelizedSparse SubtractToNewSolid(params VoxelizedSparse[] subtrahends)
        {
            var vs = (VoxelizedSparse)Copy();
        ...
        public VoxelizedSparse DraftToNewSolid(CartesianDirections vd)
        {
            var vs = (VoxelizedSparse)Copy();
        ...
        public VoxelizedSparse ErodeToNewSolid(VoxelizedSparse designedSolid, double[] dir,
            double tLimit = 0, double toolDia = 0, params string[] toolOptions)
        {
            var copy = (VoxelizedSparse)Copy();
            copy.ErodeVoxelSolid(designedSolid, dir.normalize(3), tLimit, toolDia, toolOptions);
            copy.UpdateProperties();
            return copy;
        }

        public VoxelizedSparse ErodeToNewSolid(VoxelizedSparse designedSolid, CartesianDirections dir,
            double tLimit = 0, double toolDia = 0, params string[] toolOptions)
        {
            var copy = (VoxelizedSparse)Copy();
        ...
        private void ErodeVoxelSolid(VoxelizedSparse designedSolid, double[] dir,
        ...
        private void ErodeMask(VoxelizedSparse designedSolid, int[][] mask, byte signX, byte signY,
    ...
    public class VoxelSparseEnumerator : IEnumerator<int[]>
    {
        ...
        int yLim;
        int zLim;
        public VoxelSparseEnumerator(VoxelizedSparse vs)
        {
            this.vs = vs;
