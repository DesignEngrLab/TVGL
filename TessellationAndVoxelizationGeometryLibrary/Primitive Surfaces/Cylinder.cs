    ...
    public class Cylinder : PrimitiveSurface
    {
            ...
            : base(facesAll)
        {
            ...
            foreach (var face in faces)
                radii.AddRange(face.Vertices.Select(v => GeometryFunctions.DistancePointToLine(v.Position, center, axis)));
            ...
            : base(new List<PolygonalFace>(new[] { edge.OwnedFace, edge.OtherFace }))
        {
            ...
            double[] center;
            GeometryFunctions.SkewedLineIntersection(edge.OwnedFace.Center, edge.OwnedFace.Normal,
            ...
            var d1 = GeometryFunctions.DistancePointToLine(v1.Position, center, axis);
            var d2 = GeometryFunctions.DistancePointToLine(v2.Position, center, axis);
            var d3 = GeometryFunctions.DistancePointToLine(v3.Position, center, axis);
            var d4 = GeometryFunctions.DistancePointToLine(v4.Position, center, axis);
