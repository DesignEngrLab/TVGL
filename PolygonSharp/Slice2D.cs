...
namespace PolygonSharp
{
    public static partial class PolygonOperations
    {
            ...
            double offsetAtLineForPositiveSide = 0.0)
        {
            ...
            distances.SetPositiveAndNegativeShifts(perpendicularDistanceToLine,MathF.Pow(10, -shallowPolygonTree.NumSigDigits), ref positiveShift, ref negativeShift);
            ...
            Vector2 lineNormalDirection, double distanceAlongDirection)
        {
            ...
            var positiveShift = 0.0;
            var negativeShift = 0.0;
            distances.SetPositiveAndNegativeShifts(distanceAlongDirection, MathF.Pow(10, -shallowPolygonTree.NumSigDigits), ref positiveShift, ref negativeShift);
