...
namespace PolygonSharp
{
    ...
    public static partial class PolygonOperations
    {
        ...
        private static double DefineDeltaAngle(double offset, double tolerance, double maxCircleDeviation)
        {
            ...
            return 2 * MathF.Acos(1 - MathF.Abs(maxCircleDeviation / offset));
        }
        ...
        private static List<Polygon> OffsetJust(this Polygon polygon, double offset, bool notMiter, double deltaAngle = double.NaN)
        {
            ...
            var longerLength = MathF.Max(bb.Length1, bb.Length2);
        ...
        {
            var tolerance = MathF.Pow(10, -polygon.NumSigDigits);
            ...
            if (roundCorners) startingListSize += (int)(2 * MathF.PI / deltaAngle);
            var offsetSign = MathF.Sign(offset);
            ...
            for (int i = 1; i <= numPoints; i++)
            {
                ...
                else if (cross * offset > 0)
                {
                    ...
                    if (roundCorners)
                    {
                        ...
                        // to avoid "costly" call to MathF.Sin and MathF.Cos, we create the transform matrix that 1) translates to origin
                    ...
                    else
                    {
                        ...
                        if (vectorToCornerLengthSquared > maxLengthSquared)
                            intersection =
                                point + vectorToCorner * MathF.Sqrt(maxLengthSquared / vectorToCornerLengthSquared);
