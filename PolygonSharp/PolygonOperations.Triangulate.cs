        ...
        private static List<Vertex2D[]> Triangulate(this Polygon polygon, bool handleSelfIntersects = true)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    triangleArea = localTriangleFaceList
                       .Sum(tri => MathF.Abs((tri[1].Coordinates - tri[0].Coordinates).Cross(tri[2].Coordinates - tri[0].Coordinates))) 
                       / 2;
                }
                catch
                {
                ...
                successful = 2 * MathF.Abs(polygon.Area - triangleArea) / (polygon.Area + triangleArea) < 0.01;
                ...
                angle = random.NextDouble() * 2 * MathF.PI;
