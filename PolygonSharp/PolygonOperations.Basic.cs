...
namespace PolygonSharp
{
    ...
    public static partial class PolygonOperations
    {
        ...
        public static double Perimeter(this IEnumerable<Vector2> polygon)
        {
            var perimeter = 0.0;
            var firstpass = true;
            var firstPoint = Constants.NullVector;
            var prevPoint = Constants.NullVector;
        ...
        public static IEnumerable<Vector2> ConvertToVector2s(this IEnumerable<float> coordinates)
        {
        ...
        {
            if (confidencePercentage > 1.0 || MathF.Sign(confidencePercentage) < 0)
            ...
            var sqrRootTerm = MathF.Sqrt(perimeter * perimeter - 16 * area);
        ...
        public static bool IsCircular(this IEnumerable<Vector2> polygon, out Circle minCircle, double confidencePercentage = Constants.HighConfidence)
        {
            ...
            var polygonArea = MathF.Abs(points.Area());
