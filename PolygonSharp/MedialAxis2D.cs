                    ...
                    if (triangleCenterLineVertices.Any())
                    {
                        ...
                        if (triangleCenterLineVertices.Count == 3)
                        {
                            ...
                            else
                            {
                                ...
                                if (d0 < d1 && d0 < d2)
                                    newPoint = (edge1Center + edge2Center) / 2;
                                else if (d1 < d2)
                                    newPoint = (edge2Center + edge3Center) / 2;
                                else
                                    newPoint = (edge3Center + edge1Center) / 2;
                ...
                while (branches.Any())
                {
                    ...
                    while (!hitEndOfBranch && !hitNode)
                    {
                        ...
                        foreach (var node in nodes)
                        {
                            ...
                            {
                                if (branches[j][0].IsPracticallySame(p1, 0.0001) &&
                                   branches[j][1].IsPracticallySame(p2, 0.0001))
                                {
                                    branches.RemoveAt(j);
                                    break;
                                }
