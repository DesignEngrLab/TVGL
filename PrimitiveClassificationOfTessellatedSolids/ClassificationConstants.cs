...
namespace PrimitiveClassificationOfTessellatedSolids
{
    internal static class ClassificationConstants
    {
        ...
        internal static List<List<int>> readingEdgesRules2()
        {
            ...
            var reader = new StreamReader(File.OpenRead(TesselationToPrimitives.CSVPath + "/PrimitiveClassificationOfTessellatedSolids/NewEdgeRules.csv"));
        ...
        internal static List<List<int>> readingFacesRules()
        {
            ...
            var reader = new StreamReader(File.OpenRead(TesselationToPrimitives.CSVPath + "/PrimitiveClassificationOfTessellatedSolids/NewFaRules.csv"));
